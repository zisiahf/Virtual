    ...
    function(a) {
        ...
        function c(c) {
            ...
            document.oncontextmenu = function() {
                ...
                if (null == a) throw new Error("Stage.remove??o����?: ?????��??onull!");
                for (var b = 0; b < this.childs.length; b++)
            ...
            this.initialize = function(c) {
                ...
                if (null != this.alarm && "" != this.alarm) {
                    var b = this.alarmColor || "255,0,0",
                        c = this.alarmAlpha || .5;
                    a.beginPath(), a.font = this.alarmFont || "10px ???��?����?����?��";
                ...
                if (null == b) throw new Error("Node.setImage(): ?????��Image?��1����???o??o!");
                var d = this;
                if ("string" == typeof b) {
                    var e = j[b];
